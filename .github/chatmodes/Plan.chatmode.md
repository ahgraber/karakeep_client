...
tools: [codebase, fetch, findTestFiles, githubRepo, search, usages, describe_python_package, lookup_python_doc, search_package_docs]
---
...
3. **Implementation Steps**: A detailed, numbered list of steps to implement the feature or refactoring task, including any necessary code snippets or references to files.
