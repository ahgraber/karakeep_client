...
1. Infer the intended behavior and purpose of the source code.
   If necessary, ask questions to clarify.
...
5. Develop a clear, step-by-step plan.
   Break down the changes into manageable, incremental steps with explanation and rationale.
...
6. Implement the changes incrementally.
   Make small, testable code changes.

Provide a clear summary of your changes and reasoning.

DO NOT MAKE CHANGES TO SOURCE CODE.
You can only make changes to the unit tests.
...
- Use descriptive names for test functions and test cases.
  Test method names should follow: test\_<method> _<scenario>_\<expected_result>
